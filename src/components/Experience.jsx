...
const jobs = [
  {
    ...
    duration: '10+ years',
    summary:
      'Architecting and leading enterprise-scale risk and compliance programs end-to-end across the full controls lifecycle — from design and implementation through monitoring, testing, and remediation. Building and shipping AI-powered tools that eliminate the manual, repetitive effort that has historically defined this function, driving measurable efficiency gains across audit, risk, and compliance workflows. Directing $5M+ client engagements end-to-end — owning revenue delivery, resource allocation, and margin performance — while reporting directly to C-suite and executive leadership, and operating fluently across all three lines of defense.',
    bullets: [
      ...
      { text: 'Co-led a firm-wide AI initiative — designing proofs of concept and expanding the compliance practice into AI-enhanced risk and controls engagements.', impact: 'AI initiative leadership' },
    ],
